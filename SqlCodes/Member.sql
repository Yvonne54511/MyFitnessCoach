...
-- Instructor 功能
(N'ManageOwnProfile'),          -- 1  營養師資料維護
(N'ManageSchedule'),            -- 2  排班表管理
(N'ViewOwnAppointments'),       -- 3  查看自己被預約時段
(N'ReportComment'),             -- 4  檢舉評論區
-- Purchasor 功能
(N'ManageProducts'),            -- 5  商品上架
(N'ManageCategories'),          -- 6  類別管理
(N'ManageOrders'),              -- 7  訂單管理
-- Marketor 功能
(N'ManageTopUpPlans'),          -- 8  儲值方案管理
(N'ManageTopUpOrders'),         -- 9  儲值訂單管理
(N'QueryMemberBalance'),        -- 10 客戶點數查詢
-- Admin 專屬功能
(N'ToggleInstructorActive'),    -- 11 上下架營養師
(N'SuspendStaff');              -- 12 對員工停權
GO
